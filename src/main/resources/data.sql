...
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (4,'violet4','aetj','erat','1985',5);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (5,'indigo5','srykryk','non','1958',6);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (6,'blue6','xhm.','eleifend','1993',3);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (7,'yellow7','aet','dolor.','1969',5);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (8,'violet8','fhmxhfm.','accumsan','2015',3);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (9,'orange9','xfhmxf','Proin','1973',7);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (10,'violetg','uldtuld.','dictum','1994',6);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (11,'violrget','znzdg','sapien,','1967',10);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (12,'blurgre','at','j,dt,d','1971',9);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (13,'orafbfnge','zzgfgm','elementum','2012',2);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (14,'viofbflet','srsyrsr.','arcu.','1944',7);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (15,'blgbue','zgmzgm.','est.','1971',2);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (16,'gbrgbr','zgmyk','nonummy.','1957',1);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (17,'grbrbeen','rkrykryk','egestas','1944',4);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (18,'gbr','rykky','mauris','2018',1);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (19,'rgbrb','uleudtu','sit','1977',2);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (20,'rbrg','dtdtulx.','sem','2011',2);
INSERT INTO CAR (ID,COLOR,LICENSE_PLATE,MODEL,YEAR,USUARIO_ID) VALUES (21,'bgrbg','yytksry','accumsan','1978',2);
*/
